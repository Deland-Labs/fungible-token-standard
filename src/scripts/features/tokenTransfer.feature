...
Feature: token transfer
  ...
  Scenario Outline:Transfer token to a receiver
    ...
    Examples:
      ...
      | dft_miner | dft_user14 | dft_fee_charger | 100  | dft_basic        | 99899.99 | 100     | 0.02    |
      | dft_user1 | dft_user14 | dft_fee_charger | 100  | dft_all_features | 99899.99 | 100     | 10.01   |
      | dft_user2 | dft_user14 | dft_fee_charger | 100  | dft_burnable     | 99898    | 100     | 2002.00 |
      | dft_user3 | dft_user14 | dft_fee_charger | 100  | dft_mintable     | 99890    | 100     | 10010   |

  Scenario:Transfer twice with same property will fail
    When "dft_miner" transfer "100" "dft_basic" to "dft_user14" twice, the second will fail

  Scenario:Transfer passed 1 days will fail
    When "dft_miner" transfer "100" "dft_basic" to "dft_user14" passed "1" days will fail
