...
Feature: token approve and transfer from
  ...
  Background:
    Given Reinstall dft canisters
      ...
      | dft_burnable_mintable | Test Token 2 | TST2   | 8        | 100000000    | 0.001       | 0.0001   | 4             | dft_main |
    ...
    And transfer token from "dft_main" to these users
      ...
      | dft_burnable_mintable | dft_user1 | 100000 |
    ...
    And approve tokens from owner to spender in table
      ...
      | dft_burnable_mintable | dft_user1 | dft_user2 | 100000 |
  ...
  Scenario Outline:Transfer token from the owner to a receiver
    ...
    Examples:
      ...
      | dft_user2 | dft_user1 | dft_receiver | dft_fee_charger | 100  | dft_burnable_mintable | 99899.989   | 0             | 100            | 10.011  |
