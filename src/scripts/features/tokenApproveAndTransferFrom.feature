...
Feature: token approve and transfer from
  ...
  Background:
    ...
    And approve tokens from owner to spender in table
      ...
      | dft_all_features | dft_user1 | dft_user2 | 100000 |
  ...
  Scenario Outline:Transfer token from the owner to a receiver
    ...
    Examples:
      ...
      | dft_user1 | dft_miner | dft_user14 | dft_fee_charger | 100  | dft_basic        | 99899.98    | 0             | 100            | 0.03    |
      | dft_user2 | dft_user1 | dft_user14 | dft_fee_charger | 100  | dft_all_features | 99899.989   | 0             | 100            | 10.011  |
      | dft_user3 | dft_user2 | dft_user14 | dft_fee_charger | 100  | dft_burnable     | 99897.8     | 0             | 100            | 2002.2  |
      | dft_miner | dft_user3 | dft_user14 | dft_fee_charger | 100  | dft_mintable     | 99889.7     | 0             | 100            | 10010.3 |
