...
static mut OWNER:  sudograph::ic_cdk::export::Principal =  sudograph::ic_cdk::export::Principal::anonymous();
static mut TOKEN_CANISTER_ID:  sudograph::ic_cdk::export::Principal =  sudograph::ic_cdk::export::Principal::anonymous();
...
async fn post_upgrade_costom() {
    let (owner,token_canister_id ) : ( sudograph::ic_cdk::export::Principal  ,  sudograph::ic_cdk::export::Principal) = sudograph::ic_cdk::storage::stable_restore().unwrap();
    unsafe {
        OWNER = owner; 
