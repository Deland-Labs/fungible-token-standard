...
pub const  EXTEND_KEYS:[&str;15]=[OFFICIAL_SITE,MEDIUM,OFFICIAL_EMAIL,DESCRIPTION,BLOG,REDDIT,SLACK,FACEBOOK,TWITTER,GITHUB,TEGEGRAM,WECHAT,LINKEDIN,DISCORD,WHITE_PAPER];